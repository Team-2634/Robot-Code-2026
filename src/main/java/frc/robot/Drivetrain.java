...
public class Drivetrain {
  ...
  public void drive(
    ...
    m_frontLeft.setDesiredState( swerveModuleStates[0], 0, "F_L_Steer");
    m_frontRight.setDesiredState(swerveModuleStates[1], 1, "F_R_Steer");
    m_backLeft.setDesiredState(  swerveModuleStates[2], 2, "B_L_Steer");
    m_backRight.setDesiredState( swerveModuleStates[3], 3, "B_R_Steer");
  }
  ...
  public void straightenWheels(double periodSeconds) {
    ...
    //     .toSwerveModuleStates(ChassisSpeeds.discretize(wheelOrientationReset, periodSeconds));
